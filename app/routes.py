from app.batis.add_general_route import add_general_route
from app.controller.add_auth_route import add_auth_route
from app.controller.add_batis_demo_route import add_batis_demo_route
...
routes = [
  ...
  add_auth_route,               # 登录注册相关接口
  add_concurrent_route,         # 并发充值接口
  add_batis_demo_route,         # batis_demo 测试接口
